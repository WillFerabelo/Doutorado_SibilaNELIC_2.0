...
class FichasNotasView:
    ...
    def render(self):
        ...
        with c_esq:
            st.markdown(
                ...
                <div class="nelic-card">
                    ...
                    <div>
                        ...
                        <strong>Subtítulo:</strong> {reg_sel.get('subtitulo_artigo','')}
                    </div>
            ...
            with st.expander("🎯 Assuntos e Autores", expanded=False):
...
def main():
    ...
    # --- EXPLORAR DADOS ---
        ...
        if not df.empty:
            ...
            termo = c1.text_input("Busca Livre (Título/Resumo):")
            ...
            st.dataframe(
                res,
                column_config={"n": "Rev", "titulo_artigo": "Título", "autores_colaboradores": "Autores"},
                width='stretch',
                height=320
            )
